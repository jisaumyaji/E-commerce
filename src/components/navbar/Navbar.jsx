    ...
    <div className='bg-zinc-950 sticky top-0 z-50'>
      <Transition.Root show={open} as={Fragment}>
        <Dialog as='div' className='relative z-40 lg:hidden' onClose={setOpen}>
          ...
          <div className='fixed inset-0 z-40 flex'>
            ...
            >
              <Dialog.Panel className='relative flex w-full max-w-xs flex-col overflow-y-auto bg-zinc-950 pb-12 shadow-xl' style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '' }}>
                ...
                <div className='space-y-6 border-t border-gray-200 px-4 py-6'>
                  ...
                  {user?.user?.email === "patelsaumya@gmail.com" ? <div className='flow-root'>
      ...
      <header className='relative bg-zinc-950'>
        {/* <p className='flex h-10 items-center justify-center bg-red-600 px-4 text-sm font-medium text-white sm:px-6 lg:px-8'
          style={{ backgroundColor: mode === 'dark' ? 'rgb(62 64 66)' : '', color: mode === 'dark' ? 'white' : '' }} hidden >
          Get free delivery on orders over ₹300
        </p> */}

        <nav aria-label='Top' className='bg-zinc-950 px-4 sm:px-6 lg:px-8 shadow-xl ' style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '' }}>
          <div className=''>
            <div className='flex h-16 items-center'>
              ...
              <div className='ml-4 flex lg:ml-0'>
                <Link to={'/'} className='flex'>
                  <div className='flex '>
                    <h1 className=' text-2xl font-bold text-white px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '' }}>e-commerce</h1>
                  </div>
                </Link>
              </div>
              ...
              <div className='ml-auto flex items-center'>
                <div className='hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6'>
                  ...
                  {user?.user?.email === 'patelsaumya705435@gmail.com' ?
                ...
                {/* <div className='hidden lg:ml-8 lg:flex' hidden>
                ...
                <div className='ml-4 flow-root lg:ml-6'>
                  <Link to={'/cart'} className='group -m-2 bg-white flex items-center p-2' style={{ color: mode === 'dark' ? 'white' : '' }}>
                    <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' strokeWidth={1.5} stroke='currentColor' className='w-6 h-6'>
